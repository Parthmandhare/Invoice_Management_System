...
const Table = ({ data, func }) => {
    ...
    const [rowsPerPage] = useState(5); // You can adjust the number of rows per page
    ...
    const getCurrentPageData = (page, data) => {
                ...
                <div className="overflow-x-auto pb-4">
                    <div className="min-w-full inline-block align-middle">
                        <div className="overflow-hidden border rounded-lg border-gray-300">
                            <table className="table-auto min-w-full rounded-xl">
                                <thead>
                                    <tr className="bg-gray-50">
                                        ...
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Vendor Name </th>
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Invoice </th>
                                        ...
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Net Amount </th>
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Invoice Date </th>
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Due Date </th>
                                        <th scope="col" className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Department </th>
                                ...
                                <tbody className="divide-y divide-gray-300">
                                    {
                                        paginatedData.map((invoice) => {
                                            return (
                                                <tr className="bg-white transition-all duration-500 hover:bg-gray-50" key={invoice._id}>
                                                    <td className="">
                                                        <div className="flex items-center py-5 px-5">
                                                            <input type="checkbox" value="" className="w-5 h-5 appearance-none border border-gray-300 rounded-md mr-2 hover:border-indigo-500 hover:bg-indigo-100 checked:bg-no-repeat checked:bg-center checked:border-indigo-500 checked:bg-indigo-100"/>
                                                        </div>
                                                    ...
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Vendor_Name}</td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Invoice_Number}</td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                        <div className="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                                            ...
                                                            <span className="font-medium text-xs text-emerald-600">{invoice.Status}</span>
                                                        </div>
                                                    </td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Net_Amount}₹</td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Invoice_Date}</td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Due_Date}</td>
                                                    <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{invoice.Department}</td>
                                                    <td className="flex p-5 items-center gap-0.5">
                                                        <button className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center" onClick={() => handleDelete(invoice._id)}>
                            ...
                            <div className="pagination mt-5 flex justify-center items-center mb-5">
                                <button onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1} className="px-4 py-2 mr-2 bg-gray-200 rounded-md cursor-pointer">Previous</button>
                                <span className="px-4 py-2">{currentPage} of {totalPages}</span>
                                <button onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages} className="px-4 py-2 ml-2 bg-gray-200 rounded-md cursor-pointer">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
